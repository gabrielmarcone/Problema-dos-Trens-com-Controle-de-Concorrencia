...
* Nome.............: Principal.java
* Funcao...........: Classe principal do projeto de trens com layout
  do jogo Minecraft, onde esta inserido o main do arquivo.
*************************************************************** */
  ...
  *************************************************************** */
  ...
  public void start(Stage primaryStage) {
    try {
      ...
      Image icon = new Image("image/AppIcon.png"); // Carrega uma imagem para ser usada como icone da aplicacao
      ...
      primaryStage.setTitle("Trilhos de Trens do Minecraft"); // Define o titulo da aplicacao que aparece na barra superior da janela
